...
### 1️⃣ **IDENTIFY the Negative Thought**
...
### 3️⃣ **EXPLORE Alternative Perspectives**
...
### ⏱️ **MINUTE 3: Expanding Awareness**
...
*"You are braver than you believe, stronger than you seem, and smarter than you think." - A.A. Milne*"""
    ...
    with st.sidebar:
        ...
        st.markdown("### 🧘‍♀️ Therapeutic Exercises")
        ...
        **Enhanced Features:**
        ...
        - ❤️ Evidence-based therapeutic responses tailored to your emotional state
        - 🔍 Comprehensive crisis detection with specialized support resources
        - 📊 Mood tracking and personalized insights over time
        - 🧘‍♀️ Guided evidence-based therapeutic exercises and techniques
